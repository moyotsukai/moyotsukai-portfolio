  ...
  return (
    <div>
      ...
      <BlogContainer>
        ...
        <Br />
        <p>
          例えば、『循環』は大きさ140cm×140cmで、大小のカブトガニを螺旋状に並べた作品。カブトガニは1齢幼生から17齢の成体まで、各成長のステップごとの大きさを実物大で再現している。この作品で切り取られている景色は、ある1個体のカブトガニの一生をとらえた時間の流れ。この作品内で観測できるカブトガニがわずかであるからこそ、これより前にも後にもたくさんのカブトガニがいることが想像できる。無限に流れる時間、無限に流れる生命のサイクル、そんなコンセプトで『循環』というタイトルをつけた。
        </p>
        <Br />
        ...
        <Br />
        <p>
          コウイカには“浮遊”というイメージが似合う。宇宙船のようなイメージ。では、そのコウイカが住んでいる空間や時間は何なのか？始まりも終わりもない無限。作品のタイトルは『軌道』とした。
        </p>
        <Br />
        <p>
          ペーパークラフト制作の過程では、大量の試作品を作っては修正し、試行錯誤を繰り返す。コウイカの作品でも、様々なパターンを試し、40個以上の試作品を作った。幅1mの巨大なバージョンも作ったが、生き物っぽくなくなってしまったので諦めた。コウイカといえば、色や模様がディスプレイのように変化するのが特徴だ。腕の形にはバリエーションを持たせていて、軌道上のコウイカが徐々に変形するような様子を見せている。背面には矢羽のようなパターンを使っている。一定間隔ごとのマスに薄く色を塗ることで、見る角度によって模様が変化して見えるようになっている。
        </p>
        <Br />
        <ImageGallery images={images_5} />
        <Br />
        <p>
          制作には4ヶ月かかり、展覧会の期限になったので区切りをつけて完成とした。次の展示までにはもっと大きく、もっと細かく、たくさん作りたい。
        </p>
        <Br />
        <p>
